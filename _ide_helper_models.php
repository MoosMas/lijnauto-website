 ...
 * @property int $id
 * @property int $car_id
 * @property string $checkpoint_color
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Log whereCarId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Log whereCheckpointColor($value)
